...
/**
 * Code from https://github.com/d3/d3-force/pull/115
 */
export default function(x0, y0, x1, y1) {
  ...
  force.x0 = function(_) {
    return arguments.length
      ? ((x0 = typeof _ === "function" ? _ : constant(+_)), initialize(), force)
      : x0;
  };

  force.x1 = function(_) {
    return arguments.length
      ? ((x1 = typeof _ === "function" ? _ : constant(+_)), initialize(), force)
      : x1;
  };

  force.y0 = function(_) {
    return arguments.length
      ? ((y0 = typeof _ === "function" ? _ : constant(+_)), initialize(), force)
      : y0;
  };

  force.y1 = function(_) {
    return arguments.length
      ? ((y1 = typeof _ === "function" ? _ : constant(+_)), initialize(), force)
      : y1;
  };
